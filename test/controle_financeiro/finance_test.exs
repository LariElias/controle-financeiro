defmodule ControleFinanceiro.FinanceTest do
  ...
  describe "transactions" do
    ...
    test "create_transaction/1 with valid data creates a transaction" do
      valid_attrs = %{data: ~N[2025-06-10 16:29:00], descricao: "some descricao", valor: "120.5", tipo: "some tipo"}

      assert {:ok, %Transaction{} = transaction} = Finance.create_transaction(valid_attrs)
      assert transaction.data == ~N[2025-06-10 16:29:00]
    ...
    test "update_transaction/2 with valid data updates the transaction" do
      transaction = transaction_fixture()
      update_attrs = %{data: ~N[2025-06-11 16:29:00], descricao: "some updated descricao", valor: "456.7", tipo: "some updated tipo"}

      assert {:ok, %Transaction{} = transaction} = Finance.update_transaction(transaction, update_attrs)
      assert transaction.data == ~N[2025-06-11 16:29:00]
